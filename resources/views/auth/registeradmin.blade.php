<x-guest-layout>
    <form method="POST" action="{{ route('registerAdmin.post') }}">
        @csrf
        ...
        <!-- Admin -->
        <div class="mt-4">
            <x-input-label for="admin" :value="__('Es administrador:')" />

            <select
                class="text-black mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500"
