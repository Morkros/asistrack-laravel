                    ...
                    <div class="mt-4">
                        <form action="{{ route('students.update', $students->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="text-black mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $students->name }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="text-black mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 form-control @error('lastname') is-invalid @enderror" id="lastname" name="lastname" value="{{ $students->lastname }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" class="text-black mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 form-control @error('birthdate') is-invalid @enderror" id="birthdate" name="birthdate" value="{{ $students->birthdate }}">
